...
class HealthDashboardDelegate: ObservableObject {
    @Published var noHealthData: Bool = true
}
...
struct HealthDashboardView: View {
    ...
    @ObservedObject var delegate: HealthDashboardDelegate
...
struct HealthDashboardView_Previews: PreviewProvider {
    static var previews: some View {
        HealthDashboardView(healthKitController: HealthKitController.shared, activeCalories: Calories(), consumedCalories: Calories(), caloricDeficits: Calories(), weight: Weight(), bodyFat: Weight(), delegate: HealthDashboardDelegate())
    }
}
